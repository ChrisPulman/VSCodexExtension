...
REQUIRED = [SOLUTION,'docs/PLAN.md','scripts/install-vsix-experimental.ps1','src/VSCodexExtension/VSCodexExtension.csproj','src/VSCodexExtension/source.extension.vsixmanifest','src/VSCodexExtension/VSCodexExtensionPackage.cs','src/VSCodexExtension/ToolWindows/CodexToolWindowPane.cs','src/VSCodexExtension/ViewModels/CodexToolWindowViewModel.cs','src/VSCodexExtension/Views/CodexToolWindowControl.xaml','src/VSCodexExtension/Resources/codex-bridge.mjs']
...
for rel in [SOLUTION,'src/VSCodexExtension/VSCodexExtension.csproj','src/VSCodexExtension/source.extension.vsixmanifest','src/VSCodexExtension/Views/CodexToolWindowControl.xaml','src/VSCodexExtension/Commands/CodexCommands.vsct']:
